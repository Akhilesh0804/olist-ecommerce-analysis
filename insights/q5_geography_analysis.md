...
| State code | State name | Total orders | Avg review score | Avg delivery days |
|---|---|---|---|---|
...
| CE | Ceará | 1,279 | 3.9 | 21.3 |
| AC | Acre | 80 | 4.1 | 21.0 |
| PB | Paraíba | 517 | 4.1 | 20.4 |
| PI | Piauí | 476 | 4.0 | 19.5 |
| RO | Rondônia | 243 | 4.2 | 19.4 |
| BA | Bahia | 3,256 | 3.9 | 19.4 |
| RN | Rio Grande do Norte | 474 | 4.2 | 19.3 |
| PE | Pernambuco | 1,593 | 4.1 | 18.4 |
| MT | Mato Grosso | 886 | 4.1 | 18.0 |
| TO | Tocantins | 274 | 4.2 | 17.7 |
| ES | Espírito Santo | 1,995 | 4.1 | 15.8 |
| GO | Goiás | 1,957 | 4.1 | 15.6 |
| MS | Mato Grosso do Sul | 701 | 4.2 | 15.6 |
| RS | Rio Grande do Sul | 5,345 | 4.2 | 15.3 |
| RJ | Rio de Janeiro | 12,350 | 4.0 | 15.3 |
| SC | Santa Catarina | 3,546 | 4.1 | 15.0 |
| DF | Distrito Federal | 2,080 | 4.1 | 13.0 |
| PR | Paraná | 4,923 | 4.2 | 12.0 |
| MG | Minas Gerais | 11,354 | 4.2 | 12.0 |
| SP | São Paulo | 40,501 | 4.2 | 8.8 |

**Q5b — SP seller share for worst performing states**

| State code | State name | SP seller share | Avg delivery days |
|---|---|---|---|
...
Northern or Northeastern Brazil. Roraima averages 29.4 days with a 
satisfaction score of 3.9, Amapá 27.2 days with 4.2, Amazonas 26.4 
days with 4.2, Alagoas 24.5 days with 3.8, and Pará 23.8 days with 
3.9. These states receive orders 2 to 3 times slower than São Paulo 
customers who average only 8.8 days.

**The root cause is seller concentration, not seller quality.**
Q5b reveals that 64 to 80% of orders reaching Northern states are 
...
problem rather than a seller performance issue. The same São Paulo 
sellers delivering in 8.8 days locally are delivering in 26 to 29 days 
to remote states simply due to distance.
...
Customers in the most remote states such as Amazonas, Amapá, and 
Rondônia score between 4.1 and 4.2 despite extremely long delivery 
times, suggesting adjusted expectations in these regions. The most 
concerning states are those with both long delivery times AND low scores, 
specifically Alagoas (3.8), Maranhão (3.8), Bahia (3.9), Ceará (3.9), 
and Sergipe (3.9), indicating unmet expectations rather than acceptance 
of poor service.

**Rio de Janeiro stands out as an anomaly.**
...
affect satisfaction in Rio de Janeiro and warrants further investigation.

**Recommendation.**
Olist should prioritise seller recruitment in Northern and Northeastern 
states, particularly Amazonas, Amapá, Roraima, Pará, Alagoas, Maranhão, 
and Ceará. A targeted seller onboarding program in these regions would 
directly reduce delivery times and improve customer satisfaction in 
Olist's most underserved markets. The success of Minas Gerais and Paraná 
as local seller hubs provides a replicable model for this expansion 
strategy.
...
are provided in the output tables for readability.
